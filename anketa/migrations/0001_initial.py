    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_uzb', models.CharField(blank=True, max_length=221, null=True, verbose_name='Kategoriya nomi(Uzb)')),
                ('title_rus', models.CharField(blank=True, max_length=221, null=True, verbose_name='Kategoriya nomi(Rus)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title_uzb', models.CharField(blank=True, max_length=221, null=True, verbose_name='Filial nomi(Uzb)')),
                ('title_rus', models.CharField(blank=True, max_length=221, null=True, verbose_name='Filial nomi(Rus)')),
                ('description_uzb', models.CharField(blank=True, max_length=221, null=True, verbose_name="Qo'shimcha(Uzb)")),
                ('description_rus', models.CharField(blank=True, max_length=221, null=True, verbose_name="Qo'shimcha(Rus)")),
                ('latitude', models.CharField(blank=True, max_length=221, null=True, verbose_name='Latitude')),
                ('longitude', models.CharField(blank=True, max_length=221, null=True, verbose_name='Longitude')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Vaqt')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title_uzb', models.CharField(blank=True, max_length=221, null=True, verbose_name='Vakansiya nomi(Uzb)')),
                ('title_rus', models.CharField(blank=True, max_length=221, null=True, verbose_name='Vakansiya nomi(Rus)')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='vacancies/', verbose_name='Rasm')),
                ('description_uzb', models.TextField(blank=True, null=True, verbose_name='Vakansiya haqida(Uzb)')),
                ('description_rus', models.TextField(blank=True, null=True, verbose_name='Vakansiya haqida(Rus)')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Vaqt')),
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='anketa.category', verbose_name='Kategoriya')),
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='anketa.region', verbose_name='Viloyat')),
            ],
            options={
